...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-[#f3ead8] text-[#213126] antialiased">
        <main class="grid min-h-screen place-items-center bg-[radial-gradient(circle_at_20%_20%,#f8c76b_0,transparent_26%),linear-gradient(135deg,#fff7e4_0%,#d8ead8_100%)] px-6 py-12">
            <section class="w-full max-w-4xl rounded-[2rem] bg-white/80 p-6 shadow-2xl ring-1 ring-[#213126]/10 backdrop-blur md:p-10">
                ...
                <div class="mt-8 rounded-3xl bg-[#17231a] p-6 text-white">
                    ...
                    <dl class="mt-6 grid gap-px overflow-hidden rounded-2xl bg-white/10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                    <a class="inline-flex justify-center rounded-2xl bg-[#f8c76b] px-5 py-3 text-sm font-black uppercase tracking-[0.2em] text-[#17231a] transition hover:-translate-y-0.5 hover:bg-[#ffd982]" href="{{ route('bookings.create') }}">
                        {{ __('New booking') }}
                    </a>
